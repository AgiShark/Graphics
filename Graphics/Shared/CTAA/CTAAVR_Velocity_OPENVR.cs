//CTAA VR 1.8 VIVE VELOCITY RENDER
...
namespace Graphics
{
	...
	private const RenderTextureFormat velocityFormat = RenderTextureFormat.RGHalf;
        ...
        void Awake()
        {
            ...
            velocityShader = assetBundle.LoadAsset<Shader>("assets/shaders/velocitybufferctaavr_vive.shader");
        }
            ...
            RenderTexture.active = velocityBuffer;
            {
                ...
                for (int i = 0, n = obs.Count; i != n; i++)
                {
                    ...
                    if (ob != null && ob.sleeping == false && ob.mesh != null)
                    {
                        ...
                        {
                            UnityEngine.Graphics.DrawMeshNow(ob.mesh, Matrix4x4.identity, j);
